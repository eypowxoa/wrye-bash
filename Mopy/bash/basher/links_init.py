...
def InitInstallerLinks():
    ...
    if True: #--Installation Settings
        ...
        inst_settings_menu.links.append_link(Installers_DropAtCursor())
        inst_settings_menu.links.append_link(Installers_ExportNexusIds())
        inst_settings_menu.links.append_link(Installers_Hide_99_Conflicts())
    ...
    settings_menu.append_link(Installers_DropAtCursor())
    settings_menu.append_link(Installers_ExportNexusIds())
    settings_menu.append_link(Installers_Hide_99_Conflicts())
